...
class Dislikemarbo extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //
        Schema::create('Dislikemarbo', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::table('Dislikemarbo', function(Blueprint $table)
        {
    ...
    {
        //
        Schema::dropIfExists('Dislikemarbo');
    }
}
